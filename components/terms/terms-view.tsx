      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <section className="mb-10">
          ...
          <p className="text-muted-foreground leading-relaxed">
            By accessing and using bound, you agree to be bound by these Terms of Service. If you do
        ...
        <section className="mb-10">
          ...
          <p className="text-muted-foreground leading-relaxed">
            bound provides formal verification tools for auth SDKs. We reserve the right to modify
        ...
        <section className="mb-10">
          ...
          <p className="text-muted-foreground leading-relaxed">
            All content and software related to bound are the property of bound and are protected by
        ...
        <section className="mb-10">
          ...
          <p className="text-muted-foreground leading-relaxed">
            bound shall not be liable for any indirect, incidental, special, or consequential
